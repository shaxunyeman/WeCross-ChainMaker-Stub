...
public class DeployHubContract {
  private static final Logger logger = LoggerFactory.getLogger(DeployHubContract.class);
  ...
  public static String getUsage(String chainPath) {
    ...
    return "Usage:\n"
        ...
        + DeployHubContract.class.getName()
  ...
  private static void usage() {
    System.out.println(getUsage("chains/chainmaker"));
    exit();
  }
